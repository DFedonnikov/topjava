...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user u WHERE u.id=:userId AND m.dateTime BETWEEN :dateStart AND :dateEnd ORDER BY m.dateTime DESC")
})
@Entity
